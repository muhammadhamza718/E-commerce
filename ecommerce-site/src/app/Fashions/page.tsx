...
const fashionProductData : Product[] = [
  { id: 1, name: "Elegant Evening Gown", price: 199.99, date: "2024-11-20", popularity: 90, rating: 5, image: "/evening-gown.jpg" },
  { id: 2, name: "Casual Men's T-Shirt", price: 29.99, date: "2024-11-18", popularity: 85, rating: 4, image: "/tshirt.jpg" },
  { id: 3, name: "Designer Handbag", price: 349.00, date: "2024-11-15", popularity: 95, rating: 5, image: "/handbag.jpg" },
  { id: 4, name: "Running Shoes", price: 99.99, date: "2024-11-25", popularity: 80, rating: 4, image: "/running-shoes.jpg" },
  { id: 5, name: "Formal Blazer", price: 149.99, date: "2024-11-10", popularity: 70, rating: 3, image: "/formal-blazer.jpg" },
  { id: 6, name: "Winter Scarf", price: 39.99, date: "2024-11-22", popularity: 60, rating: 3, image: "/scarf.jpg" },
  { id: 7, name: "Stylish Sunglasses", price: 89.99, date: "2024-11-30", popularity: 85, rating: 4, image: "/sunglasses.jpg" },
  { id: 8, name: "Leather Jacket", price: 249.99, date: "2024-11-12", popularity: 90, rating: 5, image: "/leather-jacket.jpg" },
];

export default function FashionPage() {
  const [filteredProducts, setFilteredProducts] = useState(fashionProductData);
  const [isDropdownOpen, setIsDropdownOpen] = useState(false);

  const handleFilter = (filterType: "latest" | "popular" | "oldest") => {
    const sortedProducts = [...fashionProductData];
    switch (filterType) {
      case "latest":
  ...
  return (
    <>
      ...
      <section className="text-center py-16 bg-gradient-to-br from-gray-700 to-gray-900">
        <h2 className="text-4xl font-bold mb-4">Latest Fashion Trends</h2>
        <p className="text-gray-400 mb-8">Shop the latest and most stylish fashion items.</p>
      </section>
